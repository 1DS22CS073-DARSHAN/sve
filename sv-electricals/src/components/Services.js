...
import { Crane, Building2, Settings, ArrowRight, CheckCircle } from 'lucide-react';
            ...
            >
              ...
              <div className="relative p-8">
                ...
                <div className="relative mb-6">
                  <div className={`inline-flex p-4 rounded-2xl bg-${service.color}-100 text-${service.color}-600 group-hover:scale-110 transition-transform duration-300`}>
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  className={`group/btn w-full bg-gradient-to-r ${service.gradient} text-white py-3 px-6 rounded-xl font-semibold flex items-center justify-center space-x-2 hover:shadow-lg transition-all duration-200`}
                >
        ...
        >
          <div className="bg-gradient-to-r from-primary-600 to-secondary-600 rounded-2xl p-8 text-white">
            ...
            <motion.button
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="bg-white text-primary-600 px-8 py-3 rounded-full font-semibold hover:bg-gray-100 transition-colors duration-200"
            >
              Get Custom Quote
            </motion.button>
          </div>
